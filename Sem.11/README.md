...
### **Дефиниция**
Рекурсия е програмна техника, при която дадена функция извиква сама себе си при решаването на определен проблем. Такива функции наричаме рекурсивни. <br />
...
Ако дадена рекурсивна функция **няма** дъно на рекурсията, тя ще стане **безкрайна** и резултатът ще е **StackOverflowException**.
...
Когато създаваме рекурсивни функции, трябва да разбием задачата, която решаваме, на подзадачи, за чието решение можем да използваме същия алгоритъм (рекурсивно). <br />
...
Когато в тялото на функция се извършва извикване на същата функция, казваме, че функцията е **пряко рекурсивена**. <br />
```c++
...
Ако функция A се обръща към функция B, B към C, а С отново към А, казваме, че функцията А, както и функциите В и C са **непряко (косвено) рекурсивни** или **взаимно-рекурсивни**. <br />
Веригата от извиквания при косвената рекурсия може да съдържа множество функциии, както и разклонения, т.е. при наличие на едно условие да се извиква една функция, а при различно условие да се извиква друга. <br />
```c++
